...
- [`gcp_storage_transfer_account`](#gcp_storage_transfer_account)
...
# `gcp_storage_transfer_account`

The `gcp_storage_transfer_account` service account and all the resources it has access to.
