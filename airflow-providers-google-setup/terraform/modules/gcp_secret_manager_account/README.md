...
- [`gcp_secret_manager_account`](#gcp_secret_manager_account)
...
# `gcp_secret_manager_account`

The `gcp_secret_manager_account` service account and all the resources it has access to.
