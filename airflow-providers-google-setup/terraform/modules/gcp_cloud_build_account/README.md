...
- [`gcp_cloud_build_account`](#gcp_cloud_build_account)
...
# `gcp_cloud_build_account`

The `gcp_cloud_build_account` service account and all the resources it has access to.
